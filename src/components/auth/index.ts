 ...
 * 
 * NEW: UnifiedAuthGuard replaces AuthGuard, AdminGuard, and AuthRedirect
 * KEPT: AuthInitializer, ConsentGate, and all form components
 */

// ============================================
// PRIMARY AUTH COMPONENTS (Use These)
// ============================================
