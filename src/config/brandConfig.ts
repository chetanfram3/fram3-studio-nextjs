  ...
  fram3: {
    ...
    colors: {
      light: {
        ...
        // ✅ FIX: Surface should be LIGHTER than background
        // background: '#f5efe5',        // Warm beige - page background (darker)
        // surface: '#e8dece',  
        background: '#e8dece',         // Very light beige - cards/dropdowns (lighter)
        surface: '#f5efe5',
